...
public interface ICounterpartService {
    Counterpart save(Counterpart counterpart) throws ObjectExistsException, ObjectNotFoundException, CustomException;
    ...
    Counterpart update(Counterpart counterpart, Long counterpartId) throws ObjectExistsException, ObjectNotFoundException, CustomException;
